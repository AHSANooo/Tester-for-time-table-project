...
def main():
    ...
    if not batch_colors:
        ...
        # Render Department and Batch filters first (in columns) so they appear above the search box on mobile
        fcol1, fcol2, fcol3 = st.columns(3)

        with fcol1:
            # Empty column for spacing (keeps UI centered on larger screens)
            st.write("")
        ...
        # After filters are displayed, render the course search box full-width so it appears below filters on mobile
