...
def main():
    ...
    if not batch_colors:
        ...
        # Render filters first (row 1) so on mobile the search bar appears below them
        ...
        # Now render the search box on the next row so it appears below filters on mobile
